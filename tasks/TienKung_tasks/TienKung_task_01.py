...
logger.info("TienKung_task_01 imports all deps")


@Registry.register("TienKung_task_01")
class TienKung_Task_01(TienKung_Task_Base):
    ...
    def check_success_callback(self, step_size) -> None:
        if self.task_checker.check_relative_position(a_path=self.switch1_prim,
